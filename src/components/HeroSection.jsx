    ...
    <section className="relative h-[70vh] w-full overflow-hidden rounded-2xl bg-[#0b0b0f] border border-white/10">
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative">
          <div
            className="mx-auto flex w-[320px] sm:w-[420px] items-center justify-between gap-4 rounded-full bg-white/90 px-6 py-4 shadow-xl backdrop-blur-md animate-[float_6s_ease-in-out_infinite]"
            style={{ boxShadow: '0 10px 40px rgba(255,255,255,0.15)' }}
          >
            <div>
              <p className="text-xs tracking-wide text-gray-500">Ai For Education</p>
              <h1 className="text-lg sm:text-xl font-semibold text-gray-900">Aame elevates learning with real-time intelligence</h1>
            </div>
            <a
